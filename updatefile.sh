...
wget -O /usr/bin/menu "https://raw.githubusercontent.com/heruahmad1/v4/main/menu/menu.sh" && chmod +x /usr/bin/menu
...
chmod +x menu-trial
chmod +x menu-vmess
#get https://raw.githubusercontent.com/heruahmad1/v4/main/menu-vless && chmod +x menu-vless
chmod +x running
chmod +x clearcache
chmod +x menu-trgo
chmod +x menu-trojan
