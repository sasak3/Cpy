...
echo -e ""
echo -e "${BIYellow} ┌┌┌┌──────────────────────────────────────────────────────┐┐┐┐${NC}"
echo -e "${BIYellow} ││││ ${BOLD}${GREEN}          .::::.  SKY-TUNNEL  .::::. ${BIYellow}        ││││${NC}"
echo -e "${BIYellow} └└└└──────────────────────────────────────────────────────┘┘┘┘ ${NC}"
echo -e "${BIYellow} ┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                      << INFORMASI VPS >>                    \E[0m" | lolcat                    
echo -e "${BIYellow} └────────────────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}      □ Current Time     =  ${GREEN}$( date -d "0 days" +"%d-%m-%Y | %X" )${NC}"
echo -e " ${BICyan}      □ ISP VPS          =  ${GREEN}${ISP} ${NC}"
echo -e " ${BICyan}      □ CITY             =  ${GREEN}${CITY} ${NC}"
echo -e " ${BICyan}      □ IP-VPS           =  ${GREEN}$IPVPS${NC}"
echo -e " ${BICyan}      □ Current Domain   =  ${GREEN}$( cat /etc/xray/domain )${NC}"
echo -e " ${BICyan}      □ NS Domain        =  ${GREEN}$(cat /root/nsdomain)${NC}"
echo -e " ${BICyan}      □ User script Exp  =  ${GREEN}$dayleft Days${NC} \033[1;36m$Name \e[0m${NC} "
echo -e "${BIYellow} ┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "       \033[0m ${BOLD}${GREEN}---${BIYellow} SSH${GREEN}  ---  ${BIYellow}VMESS  ${GREEN}---  ${BIYellow}VLESS  ${GREEN}----  ${BIYellow}TROJAN${GREEN} --- $NC "
echo -e "       \033[0m ${Blue}    $ssh1          $vma           $vla           $tra              $NC"
echo -e "${BIYellow} └────────────────────────────────────────────────────────────┘${NC}"
echo -e "${BIYellow} ┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                      << MENU TUNNELING >>                    \E[0m" | lolcat
echo -e "${BIYellow} └────────────────────────────────────────────────────────────┘${NC}"
echo -e "     ${BICyan} [•1]${NC}${GREEN} SSH OVPN MANAGER${NC}          "   "${BICyan}[•4]${NC}${GREEN} TROJAN MANAGER${NC}"
echo -e "     ${BICyan} [•2]${NC}${GREEN} VMESS MANAGER${NC}             "   "${BICyan}[•5]${NC}${GREEN} CHECK RUNNING${NC}"           
echo -e "     ${BICyan} [•3]${NC}${GREEN} VLESS MANAGER${NC}             "   "${BICyan}[•6]${NC}${GREEN} OTHER SETINGS${NC}"                                            
echo -e "${BIYellow} ┌────────────────────────────────────────────────────────────┐${NC}"
