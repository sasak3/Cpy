...
echo -e "${BIYellow}  │====================================================="
echo -e " ${BIYellow} │ ${BICyan}💠 ISP VPS        :  ${BIPurple}$ISP"
echo -e " ${BIYellow} │ ${BICyan}💠 CPU            :  ${BIPurple}$cpu_usage"
echo -e " ${BIYellow} │ ${BICyan}💠 RAM            :  ${BIPurple}$tram Mb"
 -e "${BIYellow}□ Server Uptime       = ${GREEN}$( uptime -p  | cut -d " " -f 2-10000 ) ${NC}"
