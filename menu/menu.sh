...
echo -e ""
echo -e "   ${BIYellow}   ─────────────────────────────────────────────${NC}"
echo -e "                  ${BICyan}${BIRed}.::::.  SKY-TUNNEL  .::::.${NC}"
echo -e "   ${BIYellow}   ───────────────────────────────────────────── ${NC}"
echo -e "${BIYellow}  ┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BIYellow}  │                     ${BIWhite}${UWhite}Informations${NC}"
echo -e "${BIYellow}  │====================================================="
cho  -e " ${BIYellow} │ ${BICyan}□ Current Time        =  ${GREEN}$( date -d "0 days" +"%d-%m-%Y | %X" )${NC}"
echo -e " ${BIYellow} │ ${BICyan}□ Operating System    =  ${GREEN}$( cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME//g' | sed 's/=//g' | sed 's/"//g' ) ( $( uname -m) )${NC}"
...
echo -e " ${BIYellow} │ ${BICyan}□ Time Reboot VPS     =  00:00 ${GREEN}( Jam 12 Malam )${NC}"
echo -e " ${BIYellow} │ ${BICyan}□ IP-VPS              =  ${GREEN}$IPVPS${NC}"
echo -e " ${BIYellow} │ ${BICyan}□ Expiry script${NC}  =  ${GREEN}$useexp${NC} Days"
