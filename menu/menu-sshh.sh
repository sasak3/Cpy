...
echo -e "${yelow} │  ${cyann}[•4]${NC}  ${green}Delete SSH OVPN Account${NC}"
echo -e "${yelow} │  ${cyann}[•5]${NC}  ${green}Check SSH OVPN login Account${NC}"
echo -e "${yelow} │  ${cyann}[•6]${NC}  ${green}Member SSH OVPN Account${NC}"
echo -e "${yelow} │  ${cyann}[•7]${NC}  ${green}Delete SSH OVPN Expired${NC}"
echo -e "${yelow} │  ${cyann}[•8]${NC}  ${green}Autokill SSH OVPN Account${NC}"
