...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/sasak3/v4/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/sasak3/v4/main/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/sasak3/v4/main/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/sasak3/v4/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O bot "https://raw.githubusercontent.com/sasak3/v4/main/bot.sh"
